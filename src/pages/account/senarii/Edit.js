    ...
    return (<section>
        { senario && <>
            <div className="container">
                <h1 className="title-page">Editer Votre Senario: {senario._id}</h1>
            </div>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            {senario.sections.map((section, indexSection) =>
                                <div className="card bg-blue-100 mb-20" key={indexSection}>
                                    <div className="card-body">
                                        <div className="txt-right">
                                            <button onClick={(e) => delSection(e, indexSection)} className="btn btn-sm btn-error p-20">
                                        ...
                                        <h3>Les actions</h3>
                                        { section.actions.map((action, indexAction) => <div className="card bg-white-100 mb-20" key={`action-${indexSection}-${indexAction}`}>
                                            <div className="card-body">
                                                <div className="txt-right">
                                                    <button onClick={(e) => delAction(e, indexSection, indexAction)} className="btn btn-sm btn-error p-20">
                                                        Supprimer l'action
                                                    </button>
                                                </div>
                                                <div className="form-group">
                                        ...
                                        <button onClick={(e) => addAction(e, indexSection)} className="btn btn-success w-100 p-20">
                                            Ajouter une action
                                        </button>
                                    </div>
                                </div>
                            ...
                            <button onClick={addSection} className="btn btn-success w-100 p-20">
                                Ajouter une section
                            </button>
                        </div>
                    </div>
